...
![|800]([SOAP_vs_REST_vs_GraphQL_vs_RPC|])  
...
![|600]([Forward_Proxy_v.s._Reverse_Proxy2x|])
...
![|800]([3732b33fd43043049c18e3c108bc9d1a|])  
...
![|600]([Types_of_Memory_and_Storage|])  

### Визуализация запроса SQL
![|800]([sql-execution-order|])  
...
![|600]([top_caching_strategy|])  

## Микросервисная архитектура

### Типичная микросервисная архитектура
![|600]([typical-microservice-arch|])  
...
![|800]([microservice-best-practices|])  
...
![|800]([18_Most-Used_Linux_Commands_You_Should_Know-01|])  
