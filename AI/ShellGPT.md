...
│ --interaction   --no-interaction            Интерактивный режим для опции --shell. [default: interaction]│
│ --describe-shell -d                         Описать команду оболочки.                                    │
│ --code           -c                         Генерировать только код.                                     │
│ --functions     --no-functions              Разрешить вызовы функций. [default: functions]               │
╰──────────────────────────────────────────────────────────────────────────────────────────────────────────╯
╭─ Опции чата ─────────────────────────────────────────────────────────────────────────────────────────────╮
│ --chat            TEXT  Продолжать с указанным ID, выбрать "temp" для быстрой сессии. [default: None]    │
│ --repl            TEXT  Начать сессию REPL (Чтение-Вычисление-Вывод). [по умолчанию: None]               │
│ --show-chat       TEXT  Показать все сообщения для указанного ID чата. [default: None]                   │
│ --list-chats     -lc    Список всех существующих ID чатов.                                               │
╰──────────────────────────────────────────────────────────────────────────────────────────────────────────╯
╭─ Опции для ролей ────────────────────────────────────────────────────────────────────────────────────────╮
│ --role            TEXT                      Системная роль для модели GPT. [default: None]               │
│ --create-role     TEXT                      Создать роль. [default: None]                                │
│ --show-role       TEXT                      Показать роль. [default: None]                               │
