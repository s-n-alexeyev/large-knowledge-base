...
>Скрип объединяет внешнюю дорожу в формате `mp3`, микширует звук с внутренней дорожкой (10% к 90%), добавляет в качестве первой звуковой дорожки нашу созданную, оставляя при этом существующую в качестве второй звуковой дорожки, формат аудио `aac`.
